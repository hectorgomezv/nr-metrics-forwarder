...
const NR_LOGS_ENDPOINT = process.env.NR_LOGS_ENDPOINT || 'https://log-api.newrelic.com/log/v1';
...
function httpSend(data, context) {
  return new Promise((resolve, reject) => {
    const urlObj = url.parse(NR_LOGS_ENDPOINT);
    const options = {
...
const processLogs = async (context, eventHubMessages) => {
